...
const capabilities = [
  { badge: 'Update', title: 'Core & Plugin Updates', desc: 'WordPress, CMS, and framework updates are applied safely in staging first, tested thoroughly before they ever touch production.' },
  { badge: 'Security', title: 'Security Scanning & Hardening', desc: 'Weekly malware scans, vulnerability assessments, firewall rule updates, and immediate remediation the moment a threat is detected.' },
  { badge: 'Speed', title: 'Performance Optimization', desc: 'Monthly Core Web Vitals audits, image compression, cache tuning, and database cleanup, all aimed at keeping load times under two seconds.' },
  { badge: 'Content', title: 'Content Management', desc: 'As part of our broader website support and maintenance offering, we handle content updates, new page creation, blog publishing, and media management, so your team focuses on strategy rather than CMS clicks.' },
  { badge: 'Backup', title: 'Backup & Recovery', desc: 'Daily automated backups with 30-day retention, off-site storage, and tested restore procedures mean recovery from any incident takes minutes, not days.' },
  { badge: 'Uptime', title: 'Uptime & Health', desc: '24/7 uptime monitoring with instant alerts, broken link detection, form submission testing, and SSL expiry warnings.' },
];
...
const maintenanceTypes = [
  ...
  { icon: '04', title: 'Enterprise Websites', desc: 'Multi-site maintenance, compliance documentation, change management workflows, and a dedicated account manager for larger organizations.' },
];

const processSteps = [
  { num: '01', title: 'Site Audit', desc: 'A full health check covering update status, security scan, performance baseline, backup verification, and a broken link audit.' },
  { num: '02', title: 'Onboarding', desc: 'Staging environment setup, monitoring configuration, a maintenance schedule agreement, and access documentation.' },
  { num: '03', title: 'Remediate', desc: 'Apply pending updates, fix security issues, optimize performance, and resolve every finding from the initial audit.' },
  { num: '04', title: 'Schedule', desc: 'Establish a weekly and monthly maintenance cadence, with updates, scans, backups, and performance reports running on autopilot.' },
  { num: '05', title: 'Ongoing Care', desc: 'Continuous monitoring, proactive updates, content support requests, and monthly health reports delivered straight to your inbox.' },
];
...
const faqs = [
  { q: 'What\'s included in typical website maintenance services?', a: 'Software updates, security monitoring, broken link fixes, backup management, and small content updates keep a site running smoothly after launch.' },
  { q: 'How often does a website actually need maintenance?', a: 'Core updates and security checks should happen monthly at a minimum, with website support and maintenance teams often monitoring continuously in the background.' },
  { q: 'What happens if a website is never maintained after launch?', a: 'Outdated plugins, security vulnerabilities, and slow performance tend to accumulate over time, eventually leading to crashes, hacks, or poor search rankings.' },
  { q: 'Does website support and maintenance include fixing bugs that appear after launch?', a: 'Yes. Ongoing maintenance plans typically include addressing bugs, broken functionality, and compatibility issues as browsers and devices update over time.' },
  { q: 'Are website maintenance services worth it for a simple, small business site?', a: 'Yes, even simple sites need security updates and backups. Skipping maintenance is one of the most common reasons small business websites eventually get hacked or go down.' },
];
  ...
  return (
    <div ref={pageRef} className="svc-page">
      ...
      <section className="inner-hero" aria-labelledby="maint-title" style={{ background: `linear-gradient(135deg, #060d1f 0%, #091840 60%, ${HERO_COLOR} 100%)` }}>
        ...
        <div className="con" style={{ position: 'relative', zIndex: 2 }}>
          <div className="svc-hero-animate">
            ...
            <h1 className="inner-hero-title" id="maint-title">WEBSITE MAINTENANCE<br />SERVICES</h1>
            <p className="inner-hero-sub">Ongoing updates, security scanning, performance optimization, and content management. We keep your website flawless, fast, and secure around the clock.</p>
            <div className="svc-hero-actions">
              ...
              <Link href="/hosting-services" className="btn btn-ghost-white" style={{ padding: '16px 32px', fontSize: '1rem' }}>View Maintenance Plans</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="con">
          <div className="svc-split svc-split--start">
            <div className="reveal-l">
              ...
              <h2 className="sec-title">SET IT AND<br /><em>FORGET IT, NOT QUITE</em></h2>
              <p className="sec-desc" style={{ marginBottom: '20px' }}>Websites aren&apos;t static brochures; they&apos;re living systems that need regular care. Outdated plugins, expired SSL certificates, and slow load times, however small they seem, silently erode your traffic, rankings, and conversions every single day they go unaddressed.</p>
              <p className="sec-desc">Our website support and maintenance plans handle everything, so your site stays secure, fast, and current while your team focuses on actually growing the business.</p>
              <div className="svc-check-list">
                {['Weekly updates are tested in staging before going live', 'Daily backups with 30-day retention', 'Monthly Core Web Vitals performance reports', '30-minute emergency response for site-down incidents'].map((item) => (
      ...
      <section className="svc-sec svc-sec--alt">
        <div className="con">
          <div className="svc-sec-hd-c reveal"><div className="sec-label">Core Capabilities</div><h2 className="sec-title">COMPLETE CARE.<br /><em>ZERO HEADACHES.</em></h2><p className="sec-desc">Every aspect of website health gets managed proactively, not reactively, after something has already broken.</p></div>
      ...
      <section className="svc-sec">
        <div className="con">
          <div className="svc-sec-hd-c reveal"><div className="sec-label">Platform Coverage</div><h2 className="sec-title">WE MAINTAIN<br /><em>EVERY PLATFORM</em></h2><p className="sec-desc">Purpose-built maintenance workflows exist for every major CMS, framework, and e-commerce platform we support.</p></div>
      ...
      <section className="svc-sec svc-sec--alt">
        <div className="con">
          <div className="svc-sec-hd-c reveal"><div className="sec-label">Our Process</div><h2 className="sec-title">AUDITED &amp;<br /><em>PROTECTED IN 5 STEPS</em></h2><p className="sec-desc">From the initial health check to fully managed ongoing care, onboarding stays seamless with improvements showing up almost immediately.</p></div>
      ...
      <section className="faq-sec svc-sec" aria-labelledby="maint-faq-title">
        <div className="con">
          <div className="sec-hd-c reveal"><div className="sec-label">FAQ</div><h2 className="sec-title" id="maint-faq-title">FAQs</h2></div>
