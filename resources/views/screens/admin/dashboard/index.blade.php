...
@section('content')
  <div class="container-fluid default-dashboard">
    <div class="row widget-grid">
      ...
      <div
        class="col-xxl-auto col-xl-4 col-sm-6 box-col-4 ord-xl-5 box-ord-5">
        <div class="card">
          ...
          <div class="card-body visitor-chart pt-0">
            <div class="common-flex">
              <h6>
                <span class="counter" data-target="98736">0</span>K
              </h6>
              <div class="d-flex">
                <p>
                  (
                  <span class="txt-success f-w-500 me-1">+0.4%</span>Than last week)
                </p>
              </div>
            </div>
      ...
      <div
        class="col-xxl-4 col-sm-6 ord-xl-1 ord-md-1 box-ord-1 box-col-6">
        <div class="card">
            ...
            <div class="header-top">
              ...
              <div class="card-header-right-icon">
                <div class="dropdown icon-dropdown">
                  ...
                  <div
                    class="dropdown-menu dropdown-menu-end"
                    aria-labelledby="customerButton">
                    <a class="dropdown-item" href="#!">Today</a><a class="dropdown-item" href="#!">Tomorrow</a><a class="dropdown-item" href="#!">Yesterday</a>
                  </div>
                </div>
              </div>
      ...
      <div
        class="col-xxl-5 col-lg-6 box-col-6 ord-xl-2 ord-md-3 box-ord-2">
        <div class="card">
          <div class="card-header card-no-border">
            <div class="header-top">
                    ...
                    <div class="col-xl-12">
                      <div class="card-body p-0 statistical-card">
                        <ul class="d-flex m-b-15">
                          <li>
                            <h5 class="counter" data-target="19897">
                              0
                            </h5>
              ...
              <div class="common-box">
                <ul class="common-flex">
                  <li>
                    <h6>Revenue</h6>
                    <span
                      class="common-space badge badge-light-success">
                      <i class="me-1" data-feather="trending-up"></i>$20k</span>
                  </li>
                  <li>
                    <h6>Target</h6>
                    <span class="common-space badge badge-light-danger"><i class="me-1" data-feather="trending-down"></i>$16k</span>
                  </li>
                  <li>
                    <h6>Today</h6>
                    <span class="common-space badge badge-light-success"><i class="me-1" data-feather="trending-up"></i>$1.6k</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="header-top">
              ...
              <div class="card-header-right-icon">
                <div class="dropdown icon-dropdown">
                  ...
                  <div
                    class="dropdown-menu dropdown-menu-end"
                    aria-labelledby="activityButton">
                    <a class="dropdown-item" href="#!">Today</a><a class="dropdown-item" href="#!">Tomorrow</a><a class="dropdown-item" href="#!">Yesterday</a>
                  </div>
                </div>
              </div>
              ...
              <li class="d-flex">
                ...
                <div class="w-100 ms-3">
                  <div
                    ...
                    <p class="mb-0 f-16 f-w-500">
                      Brooklyn Simmons<span class="f-w-400">(Commented:<a href="#!">&nbsp;NFT App</a>)</span>
                    </p>
                    <span class="c-light">7:00 AM </span>
                  </div>
                  <p class="mb-0 f-light pb-1">
                    This smithe design looks great...
                  </p>
              ...
              <li class="d-flex">
                ...
                <div class="w-100 ms-3">
                  <div
                    class="d-flex justify-content-between align-items-center">
                    <p class="mb-0 f-16 f-w-500">
                      Leslie Alexander<span class="f-w-400">(Shared images:<a href="#!">&nbsp; Barkha</a>)</span>
                    </p>
                    <span class="c-light">5:12 AM </span>
                  </div>
                  <p class="mb-0 f-light pb-1">
                    Food Delivery App figma &amp; Ai...
                  </p>
              ...
              <li class="d-flex">
                ...
                <div class="w-100 ms-3">
                  <div
                    ...
                    <p class="mb-0 f-16 f-w-500">
                      Kristin Watson
                      <span class="f-w-400">(Add new screen:
                        <a href="#!">&nbsp;Cuba Admin</a>)</span>
                    </p>
                    <span class="c-light">7:00 AM </span>
                  </div>
                  <p class="mb-0 f-light pb-1">
                    Make sure your AI file is cloud storage...
                  </p>
      ...
      <div
        class="col-xxl-7 col-lg-8 ord-xl-6 ord-md-6 box-ord-6 box-col-8e">
        <div class="card">
          <div class="card-header card-no-border">
            <div class="header-top">
              <h5>Recent Orders</h5>
              ...
              <table class="table" id="main-recent-order">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button
                        class="btn button-light-success txt-success f-w-500">
                        Delivered
                      </button>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <button
                        class="btn button-light-warning txt-warning f-w-500">
                        In Progress
                      </button>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <button
                        class="btn button-light-info txt-info f-w-500">
                        Pending
                      </button>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <button
                        class="btn button-light-danger txt-danger f-w-500">
                        Canceled
                      </button>
                    </td>
                  </tr>
      ...
      <div
        class="col-xxl-3 col-lg-4 col-sm-6 box-col-4 ord-xl-7 ord-md-2 box-ord-7">
      ...
      <div
        class="col-xxl-5 col-lg-6 ord-xl-9 ord-md-7 box-ord-7 box-col-6">
        <div class="card sales-report">
          ...
          <div class="card-body pt-0">
            <ul class="balance-data">
              <li>
                <span class="circle bg-primary"></span><span class="c-light ms-1">Orders</span>
              </li>
              <li>
                <span class="circle bg-warning"> </span><span class="c-light ms-1">Earnings</span>
              </li>
              <li>
                <span class="circle bg-secondary"> </span><span class="c-light ms-1">Refunds</span>
              </li>
            </ul>
      ...
      <div
        class="col-xxl-4 col-lg-6 ord-xl-10 ord-md-8 box-ord-7 box-col-6">
        <div class="card">
          <div class="card-header card-no-border">
            <div class="header-top">
          ...
          <div class="card-body pt-0">
            <ul class="appointments-wrapper">
              <li class="d-flex align-items-start">
                ...
                <div class="main-box">
                  <div class="mb-2">
                    <span>Participating Meeting</span><span class="c-o-light">There are many variations of passages
                      available</span><span class="txt-primary">2:00 PM - 4:30 PM</span>
                  </div>
                  <div>
