...
export default function Finance() {
  ...
  return (
    <div ref={pageRef} className="ind-page" style={accentStyle}>
      <Head>
        <title head-key="title">Finance & FinTech Solutions | LogicWorks — Compliant Digital</title>
        <meta head-key="description" name="description" content="Compliant, conversion optimized digital experiences for banks, credit unions, RIAs, and FinTech startups, built for an industry where trust, security, and performance are simply non negotiable." />
        <link head-key="canonical" rel="canonical" href="https://logicworks.com/industries/finance" />
      </Head>
