  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-secondary to-teal text-primary-foreground shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-105",
        ...
        gradient: "bg-gradient-to-r from-secondary to-teal text-primary-foreground hover:opacity-90 hover:shadow-lg hover:-translate-y-0.5",
        teal: "bg-teal text-primary hover:bg-teal/90 hover:shadow-lg hover:-translate-y-0.5",
      },
      size: {
