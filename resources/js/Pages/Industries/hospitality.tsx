...
export default function Hospitality() {
  ...
  return (
    <div ref={pageRef} className="ind-page" style={accentStyle}>
      <Head>
        <title head-key="title">Hospitality & Tourism | LogicWorks — Direct Booking & Reputation</title>
        <meta head-key="description" name="description" content="Direct booking engines, reputation management, and local SEO for hotels, restaurants, and travel brands, built to reduce OTA commissions and fill rooms straight from your own channels." />
        <link head-key="canonical" rel="canonical" href="https://logicworks.com/industries/hospitality" />
      </Head>
