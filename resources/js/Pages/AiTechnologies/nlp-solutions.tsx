...
export default function NlpSolutions() {
  ...
  return (
    <div ref={pageRef} className="ai-tech-page">
      <Head>
        <title head-key="title">NLP & Language Models | LogicWorks — Custom LLM Integration</title>
        <meta head-key="description" name="description" content="Custom LLM integrations and NLP pipelines turn unstructured language into genuine business intelligence, covering everything from document extraction to real time classification at enterprise scale." />
        <link head-key="canonical" rel="canonical" href="https://logicworks.com/nlp-solutions" />
      </Head>
